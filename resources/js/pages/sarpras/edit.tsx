...
export default function SarprasEdit({ kegiatan }: { kegiatan: any }) {
        ...
        <div className="py-8 bg-white min-h-screen font-sans text-gray-900">
            ...
            <div className="max-w-[95%] mx-auto max-w-3xl">
                <div className="border-b-4 border-gray-900 mb-8 pb-4 flex justify-between items-end">
                    <div>
                        <h2 className="text-3xl font-black text-gray-900 uppercase tracking-tighter mb-1">Edit Jurnal Sarpras</h2>
                        <p className="text-gray-500 text-sm font-medium uppercase tracking-wide">Perbarui arsip pemeliharaan fasilitas sekolah</p>
                    </div>
                    <Link href={`/sarpras/${kegiatan.id}`} className="bg-white text-gray-900 border-2 border-gray-900 px-4 py-2 text-xs font-bold uppercase hover:bg-gray-100 transition">Batal</Link>
                </div>
                <div className="bg-white border-2 border-gray-900 p-6 shadow-sm">
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div>
                            <label className="block text-xs font-black uppercase tracking-widest text-gray-700 mb-2">Perubahan Log / Rincian Tambahan</label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-50 border-2 border-dashed border-gray-300">
                            <div>
                                <label className="block text-xs font-black uppercase tracking-widest text-gray-700 mb-1">📸 Ganti Foto Kondisi</label>
                            ...
                            <div>
                                <label className="block text-xs font-black uppercase tracking-widest text-gray-700 mb-1">📄 Ganti Berkas Nota / Lampiran</label>
...
SarprasEdit.layout = (page: any) => <TopNavLayout>{page}</TopNavLayout>;