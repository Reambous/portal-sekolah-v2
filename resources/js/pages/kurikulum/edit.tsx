...
export default function KurikulumEdit({ kegiatan }: { kegiatan: any }) {
        ...
        <div className="py-8 bg-white min-h-screen font-sans text-gray-900">
            ...
            <div className="max-w-[95%] mx-auto max-w-3xl">
                <div className="border-b-4 border-gray-900 mb-8 pb-4 flex justify-between items-end">
                    <div>
                        <h2 className="text-3xl font-black text-gray-900 uppercase tracking-tighter mb-1">Edit Jurnal Kurikulum</h2>
                        <p className="text-gray-500 text-sm font-medium uppercase tracking-wide">Perbarui rekaman data administrasi akademik</p>
                    </div>
                    <Link href={`/kurikulum/${kegiatan.id}`} className="bg-white text-gray-900 border-2 border-gray-900 px-4 py-2 text-xs font-bold uppercase hover:bg-gray-100 transition">Batal</Link>
                </div>
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="md:col-span-2">
                                <label className="block text-xs font-black uppercase tracking-widest text-gray-700 mb-2">Nama Kegiatan</label>
    ...
    {errors.nama_kegiatan && (
        <p className="text-red-600 text-[10px] font-bold mt-2 uppercase animate-pulse">
            ⚠️ {errors.nama_kegiatan}
                        ...
                        <div>
                            <label className="block text-xs font-black uppercase tracking-widest text-gray-700 mb-2">Evaluasi / Refleksi</label>
...
KurikulumEdit.layout = (page: any) => <TopNavLayout>{page}</TopNavLayout>;