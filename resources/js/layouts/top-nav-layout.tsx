                    ...
                    <div className="flex justify-between h-16">
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-1 lg:space-x-4 sm:-my-px sm:ml-6 sm:flex">
                                ...
                                <Link href="#" className="inline-flex items-center px-3 pt-1 border-b-2 text-xs font-bold uppercase tracking-wide transition border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">Kurikulum</Link>
                                <Link href="#" className="inline-flex items-center px-3 pt-1 border-b-2 text-xs font-bold uppercase tracking-wide transition border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">Humas</Link>
                                <Link href="#" className="inline-flex items-center px-3 pt-1 border-b-2 text-xs font-bold uppercase tracking-wide transition border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300">Sarpras</Link>
